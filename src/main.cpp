...
public:
    ...
    //
    //     sf::Vertex A = voiture.getPosition();
    //     sf::Vertex B = voiture.getOldPosition();
    //     sf::Vertex C = vertices[2 * zone]; // zone precedante
    //     sf::Vertex D= vertices[2 * zone + 1];
    //
    //     if(intersect(A,B,C,D)){
    //         if(zone == 0)
    //             voiture.zone = (vertices.size() - 4)/2 - 1;
    //         else
    //             zone -= 1;
    //     }
    // }
